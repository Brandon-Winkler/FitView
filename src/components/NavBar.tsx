...
const NavBar = () => {
    ...
    <nav className='h-24 z-10 sticky top-0'>
            ...
            <ul className='flex items-center gap-[3vw]'>
                ...
                <li><Link to='/reviews' type='button' className='bg-transparent font-bebas hover:underline text-3xl text-white hover:text-FitYellow'>Reviews</Link></li>
                <li><Link to='/used-gear' type='button' className='bg-transparent font-bebas hover:underline text-3xl text-white hover:text-FitYellow'>Used Gear</Link></li>
